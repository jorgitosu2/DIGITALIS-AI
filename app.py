...
st.markdown("""
    ...
    /* Botón "Generar Ideas" con luz púrpura */
    button[kind="primary"] {
        ...
        box-shadow: 0 10px 25px -5px rgba(168, 85, 247, 0.6) !important; 
        transition: all 0.3s ease;
    }
...
# --- 🎯 ZONA DEL LOGO DE LA EMPRESA (TAMAÑO ORIGINAL GRANDE) ---
...
# EL TRUCO MAGICO: Este div absorbe el espacio transparente que sobra debajo de tu logo
...
# 2. Textos centrados debajo de la caja
